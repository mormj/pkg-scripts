...
BuildRequires:	graphviz, boost-devel, python2-devel, swig, doxygen
...
BuildRequires:	gsl-devel, tex(latex), numpy, PyQt4-devel, python2-cheetah
BuildRequires:	xdg-utils, python2-lxml, pygtk2-devel, orc-devel
BuildRequires:	desktop-file-utils, python2-mako, python2-six
BuildRequires:	uhd-devel, python2, cppzmq-devel, zeromq-devel, thrift
BuildRequires:	python2-sphinx, codec2-devel, findutils
BuildRequires:	comedilib-devel, jack-audio-connection-kit-devel
#BuildRequires:	python3-thrift
%if ! 0%{?rhel:1}
BuildRequires:	PyQwt-devel, qwt-devel, qwtplot3d-qt4-devel
%endif
Requires:	numpy, python2-wxpython, scipy, portaudio, python2-lxml
Requires:	pygtk2, python2-cheetah, PyQt4, zeromq, log4cpp-devel
#Requires:	python3-thrift
%if ! 0%{?rhel:1}
Requires:	PyQwt, python2-pyopengl
%endif
...
sed -i '1 s/^\(#!\/usr\/bin\/\)\(env\|python\).*$/\1python2/' gr-ctrlport-monitor gr-perf-monitorx
popd
